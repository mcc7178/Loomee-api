...
class RequestWeakValidateMiddleware implements MiddlewareInterface
{
    /**
        ...
        try {
            ...
            if (strlen($token) > 0) {
                ...
                if ($isValidToken) {
                    ...
                    $cache_token = Cache::getInstance()->get('hyperf-api_' . $parserData['uid']);
                    if ($token != $cache_token) {
                        throw new TokenValidException('Token无效或者过期', 401);
                    }
