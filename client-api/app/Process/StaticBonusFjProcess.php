...
class StaticBonusFjProcess extends AbstractProcess
{

    protected $signature = 'StaticBonusFjProcess';
    ...
    protected $queue_button = 'staticBonus:queue_button_fj';
            ...
            if($len > 0)
            {
                ...
                else
                {
                    ...
                    if($queue_count > 0)
                    {
                        ...
                        if(($queue_count - ($queue_success_nums + $len)) < 200)
                        {
